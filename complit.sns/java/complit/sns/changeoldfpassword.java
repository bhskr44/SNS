...
public class changeoldfpassword extends AsyncTask<String, Void, String> {
    private int byGetOrPost = 0;
    private Context context;
    private TextView roleField;

    public changeoldfpassword(Context context, TextView roleField, int flag) {
    ...
    protected String doInBackground(String... arg0) {
        try {
            ...
            String link = "http://bhaskar.esy.es/updatefpasswrd.php?username=" + username + "&password=" + password + "&newpassword=" + arg0[2];
        ...
        if ("Unsuccessful 0".equals(result)) {
            new Builder(this.context).setTitle("Pasword Not Changed").setMessage("Check Your Internet Connection.").setPositiveButton("Okay", new OnClickListener() {
                public void onClick(DialogInterface arg0, int arg1) {
                    Toast.makeText(changeoldfpassword.this.context.getApplicationContext(), "Thank You", 0).show();
                }
