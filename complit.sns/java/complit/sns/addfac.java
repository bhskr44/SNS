...
public class addfac extends AsyncTask<String, Void, String> {
    private int byGetOrPost = 0;
    private Context context;
    private TextView roleField;

    public addfac(Context context, TextView roleField, int flag) {
    ...
    protected String doInBackground(String... arg0) {
        try {
            ...
            String email = arg0[4];
            String phone = arg0[5];
            String link = "http://bhaskar.esy.es/addfac.php?name=" + name + "&username=" + username + "&facid=" + roll + "&branch=" + branch + "&email=" + email + "&phone=" + phone + "&password=" + arg0[6] + "&role=Allowed";
        ...
        if ("Record Inserted Succesfully !!".equals(result)) {
            new Builder(this.context).setTitle("Register Successfull").setMessage("The Registered User Can Use the App Now.").setPositiveButton("Okay", new OnClickListener() {
                public void onClick(DialogInterface arg0, int arg1) {
                    Toast.makeText(addfac.this.context.getApplicationContext(), "Thank You For Registering", 0).show();
                }
            ...
            new Builder(this.context).setTitle("Register Unsuccessfull").setMessage("Opps!! Something is wrong, Try Again !!").setPositiveButton("Okay", new OnClickListener() {
                public void onClick(DialogInterface arg0, int arg1) {
                    Toast.makeText(addfac.this.context.getApplicationContext(), "Make Sure You are connected to Internet", 0).show();
                }
