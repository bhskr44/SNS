...
public class snews extends AppCompatActivity {
    View o;
    TableLayout result;
    TextView role;
    String status = "new";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snews);
    ...
    public void open(View view) {
        ...
        alertDialogBuilder.setPositiveButton("Yes", new OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
                Toast.makeText(snews.this, "You clicked Yes.", 0).show();
                ...
                snews.this.startActivity(sendIntent);
            }
        });
        alertDialogBuilder.setNegativeButton("No", new OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(snews.this, "You clicked No.", 0).show();
                dialog.cancel();
            }
        });
