...
public class logins extends AsyncTask<String, Void, String> {
    ...
    public logins(Context context, TextView roleField, int flag) {
    ...
    protected String doInBackground(String... arg0) {
        try {
            ...
            String link = "http://bhaskar.esy.es/slogin.php?username=" + username + "&password=" + arg0[1];
    ...
    public void onPostExecute(String result) {
        ...
        if ("Allowed".equals(result)) {
            this.context.startActivity(new Intent(this.context.getApplicationContext(), shome.class));
            return;
        }
        new Builder(this.context).setTitle("Login Error !").setMessage("Please Check Your Internet Connection or Contact your Administrator.").setPositiveButton("Okay", new OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
                Toast.makeText(logins.this.context.getApplicationContext(), "Contact Your Admistration.", 0).show();
            }
        }).setNegativeButton("Retry", new OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(logins.this.context.getApplicationContext(), "Retry using your Correct Username & Password.", 0).show();
                dialog.cancel();
            }
