...
public class blockf extends AsyncTask<String, Void, String> {
    private int byGetOrPost = 0;
    private Context context;
    private TextView roleField;

    public blockf(Context context, TextView roleField, int flag) {
    ...
    protected String doInBackground(String... arg0) {
        try {
            String link = "http://bhaskar.esy.es/blockf.php?facid=" + arg0[0] + "&role=Blocked";
        ...
        if ("Unsuccessfull 0".equals(result)) {
            new Builder(this.context).setTitle("Block UnSuccessfull").setMessage("Try Again.").setPositiveButton("Okay", new OnClickListener() {
                public void onClick(DialogInterface arg0, int arg1) {
                    Toast.makeText(blockf.this.context.getApplicationContext(), "Thank You.", 0).show();
                }
