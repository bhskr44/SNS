...
public class fthu extends AppCompatActivity {
    View o;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fthu);
    }
    ...
    public void open(View view) {
        ...
        alertDialogBuilder.setPositiveButton("Yes", new OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
                Toast.makeText(fthu.this, "You clicked Yes.", 0).show();
                ...
                fthu.this.startActivity(sendIntent);
            }
        });
        alertDialogBuilder.setNegativeButton("No", new OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(fthu.this, "You clicked No.", 0).show();
                dialog.cancel();
            }
        });
